...
export const DB: Record<string, CommandInfo> = {
  ...
  useradd: {
    ...
    takesValue: ["s", "d", "g", "G", "u", "c", "e", "p", "k", "f",
      "--shell", "--home-dir", "--gid", "--groups", "--uid", "--comment"],
    flags: {
  ...
  usermod: {
    ...
    takesValue: ["l", "G", "s", "d", "u", "g", "c", "e", "f",
      "--login", "--groups", "--shell", "--home", "--uid", "--gid"],
    flags: {
  ...
  split: {
    ...
    takesValue: ["l", "b", "n", "a", "C", "--lines", "--bytes",
      "--number", "--suffix-length", "--line-bytes", "--additional-suffix"],
    flags: {
  ...
  iptables: {
    summary:
      "administer the Linux kernel IPv4 packet-filter rules (netfilter firewall)",
    takesValue: [
      "A", "I", "D", "P", "p", "s", "d", "j", "i", "o", "m", "t",
      "--dport", "--sport", "--state",
    ],
    flags: {
  ...
  ufw: {
    summary:
      "Uncomplicated Firewall — a friendly front-end for the iptables firewall",
    subcommands: {
  ...
  "firewall-cmd": {
    summary:
      "manage firewalld — the dynamic firewall daemon on RHEL/Fedora systems",
    takesValue: [
      "--zone", "--add-port", "--remove-port", "--add-service",
      "--remove-service", "--add-rich-rule",
    ],
    flags: {
